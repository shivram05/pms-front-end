...
function ViewerPropertyDetail() {
  ...
  const paramsOffer = useParams();
  const nav = useNavigate();

  console.log(paramsOffer.id)
  ...
  const propertyDetailsDisplay = null;
return ( <div>
      ...
      <div>
        ...
        <div className="property-card">
          ...
          <Badge pill bg="info" onClick={() => navigate("/favoriteproperty")}>Go To Favorite</Badge>
